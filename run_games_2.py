...
def do_stuff():
	...
	ql = AIAgent(eta = 0.05, explore_prob = 0.1, feature_extractor = feature_extractor) ### TODO HERE ### )
	game = Game([deck1, deck2], [ql, RandomAgent()])

	print(timeit.timeit(play_game, 'gc.enable()', number=20))
